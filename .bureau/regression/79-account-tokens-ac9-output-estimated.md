...
command: |
  ...
  jq -n '{
    ...
    conductor:{tokens:{input:20,cache_creation:30,cache_read:50,processed:100,output:10},confidence:"exact"},
    specialists:[{attempt_id:"mage-1",confidence:"exact",tokens:{input:100,cache_creation:150,cache_read:250,processed:500,output:40}}]
  }' > "$RP/posthoc.json"
