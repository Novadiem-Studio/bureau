name: account-tokens fragment-fed rework discriminator (W5) — attempt:2 without rework:true is NOT rework
command: |
...
expected: exit 0; stdout "PASS"; explicit post-hoc arg 2 yields rework_ratio.value=0.0 because neither narrative spawn is rework:true, with processed_total.value=1000
phase: 04 · feature
