...
for module in agent-contracts workflow-authoring regression-fixtures grilling tdd-seams fowler-smell-baseline canon-promotion failure-signatures adr-records; do
